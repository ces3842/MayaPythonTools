...
from PySide2.QtWidgets import QWidget, QMainWindow, QLabel, QPushButton, QHBoxLayout,QVBoxLayout, QLineEdit, QSlider
from PySide2.QtCore import Qt
from shiboken2 import wrapInstance

class LimbRiggerWdget(QWidget):
    def __init__(self):
        mayaMainWindow = LimbRiggerWdget.GetMayaMainWindow()

        for existing in mayaMainWindow.findChildren(QWidget, LimbRiggerWdget.GetWindowUniqueId()):
            existing.deleteLater()

        super().__init__(parent = mayaMainWindow)
        self.setWindowTitle("Limb Rigger")
        self.setWindowFlags(Qt.Window)
        self.setObjectName(LimbRiggerWdget.GetWindowUniqueId())
        ...
        ctrlSizeSlider.valueChanged.connect(self.ControllerSizeUpated)
    ...
    def BuildRig(self):
        ...
        mel.eval(f"curve -d 1 -n {ikfkBlendCtrlName} -p -1 3 0 -p -1 5 0 -p 1 5 0 -p 1 3 0 -p 3 3 0 -p 3 1 0 -p 1 1 0 -p 1 -1 0 -p -1 -1 0 -p -1 1 0 -p -3 1 0 -p -3 3 0 -p -1 3 0 -k 0 -k 1 -k 2 -k 3 -k 4 -k 5 -k 6 -k 7 -k 8 -k 9 -k 10 -k 11 -k 12 ;")
    ...
    def BuildIkControls(self,rootJnt,midJnt,endJnt):
        ...
        mc.makeIdentity(endCtrlName, apply = True) #freeze transform
        ...
        #get (q=True) the world space(ws=True) translation(t=true) of the root jont, returns a list of 3 value [x, y, z]
    ...
    def ControllerSizeUpated(self, newSize):
    ...
    def GetWindowUniqueId():
        return "56f6e4e17e403dccf58de3e0eb48d179"

def Run():
    limberRiggerWdget = LimbRiggerWdget()
    limberRiggerWdget.show()